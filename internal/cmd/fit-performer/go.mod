...
require (
	...
	github.com/couchbase/gocbcore/v10 v10.9.2-0.20260915143023-cd2e0d21854d // indirect
	github.com/couchbase/gocbcoreps v0.1.5-0.20260907165847-d3784e3e2bb0 // indirect
